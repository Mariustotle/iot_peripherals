...
class PinLayout(PinLayoutBase):
    ...
    def get_pin_layout(adapter:Optional[Any] = None) -> Dict[PinPosition, PinDetails]:
        ...
        pin_list:Dict[PinPosition, PinDetails] = {
            PinPosition.create(horizontal_pos=1):   PinDetails.create(type=PinType.DIGITAL, name="S", description="Digital Data Output"),
            PinPosition.create(horizontal_pos=2):   PinDetails.create(type=PinType.Power3V, name="+"),
