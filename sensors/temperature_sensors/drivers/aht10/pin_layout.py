...
class PinLayout(PinLayoutBase):
    ...
    def get_pin_layout(adapter:Optional[Any] = None) -> Dict[PinPosition, PinDetails]:
        ...
        pin_list:Dict[PinPosition, PinDetails] = {
            PinPosition.create(horizontal_pos=1):   PinDetails.create(type=PinType.Power3V, name="VIN"),
            PinPosition.create(horizontal_pos=2):   PinDetails.create(type=PinType.Ground, name="GND"),
            PinPosition.create(horizontal_pos=3):   PinDetails.create(type=PinType.I2C_SCL, name="SCL"),
            PinPosition.create(horizontal_pos=4):   PinDetails.create(type=PinType.I2C_SDA, name="SDA")                                                  
        }
